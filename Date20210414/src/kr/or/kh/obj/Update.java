	...
	public class Update {
	    ...
	    public void updateIrum() {
	    	System.out.println("수정할이름을입력하세요");
				irumUpdate = RegisterOld.input.next();
	    ...
	    public void updateReHakbun() {    	
			...
			student.hakbun = RegisterOld.input.next();
	    ...
	    public void updateReSubject() {
	    	System.out.println("수정할 과목입력:");
				professor.subject = RegisterOld.input.next();
	    ...
	    public void updateRePart() {
				...
				manager.part = RegisterOld.input.next();
	    ...
	    public String update() {
	    	...
	    	updateGubun();	  
	 			try {
					conn = RegisterOld.getConnection();
